...
public class MeetingService {
    ...
    public ApiResponse<String> acceptInvitation(String token) {
        try {
            ...
            try {
                // Tạo MeetingResponse để có thể đính kèm file .ics
                MeetingResponse meetingResponse = toMeetingResponse(meeting);
                ...
                emailService.sendInvitationResponseConfirmation(
                    ...
                    token,
                    meetingResponse // Truyền MeetingResponse để tạo file .ics
                );
